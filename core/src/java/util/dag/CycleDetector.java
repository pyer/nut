...
public class CycleDetector
{
    ...
    private final static Integer NOT_VISITED = new Integer( 0 );
...
*/
    ...
    private static boolean isNotVisited( final Vertex vertex, final Map<Vertex,Integer> vertexStateMap )
    {
        ...
        return NOT_VISITED.equals( state );
    }
    ...
    private static boolean dfsVisit( final Vertex vertex, final LinkedList<String> cycle, final Map<Vertex,Integer> vertexStateMap )
    {
